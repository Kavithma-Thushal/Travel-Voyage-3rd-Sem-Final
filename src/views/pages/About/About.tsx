    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="p-8 m-8 bg-white rounded-lg shadow-lg mt-[100px] mb-[100px]">
                <h2 className="pb-4 text-4xl font-bold text-center text-neonBlue border-b-2 border-blue-200">
                    About Us
                </h2>
                <p className="pt-4 text-lg text-gray-700 leading-relaxed">
                    ...
                    Our journey began with a simple yet profound realization: the importance of embracing innovative
                    technology for the well-being of both individuals and society.
                </p>
                <p className="pt-4 text-lg text-gray-700 leading-relaxed">
                    <strong>Mission: </strong> Our mission is to make cutting-edge technology accessible to all,
                    fostering a harmonious relationship between people and the digital world. We are committed to
                    offering a diverse range of high-quality, ethically sourced, and sustainable products that promote
                    connectivity, efficiency, and a tech-savvy lifestyle.
                </p>
                <div className="pt-6">
